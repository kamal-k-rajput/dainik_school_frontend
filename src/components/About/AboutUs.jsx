      ...
      <div className="about-us-page-container">
        <div className="about-container">
          <div>
            ...
            live doubt sessions, exclusive telegram doubt chat groups, test
            series etc. which is taken by our well accomplished and amiable
            faculties.
          </div>
        </div>
        <div className="about-container">
        ...
        <div className="about-container">
          <div>
            ...
            students. We provide lectures and study materials for CBSE as well
            as for other state boards like HBSE etc. Apart from CBSE &amp; state
        ...
        <div className="about-container">
          <div>
            ...
            limited resources, security and financial issue; Parents have fear
            of sending their child far from village for tuition. Thus, We are
            trying to solve this major problem through Dainik school website and
            app. It will be possible only if the parents and their children will
        ...
        <div className="about-container">
          <div>
            ...
            Dainik School provides a world full of learning for students.
            Benefits of online education Increased students interaction Student
            centered Cost effective Flexibility Online documentation Accessible
            24*7 The education sector has undergone drastic transformation in
            recent times. Online education is not limited up to classroom its
            whole world to learn and online education provides better learning
            vision to students. Welcome to the world of Dainik School.
          </div>
        </div>
      </div>
